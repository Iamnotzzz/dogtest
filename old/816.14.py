...
def on_aruco_marker_detected(ser, marker_id):
    def process_marker():
        ...
        # 第一次识别到14时执行抓取
        if marker_detection_count == 0 and (marker_id == '1' or marker_id == '4'):
            # 保证机械臂爪子在原位
        ...
        if marker_detection_count != 0 and (marker_id == '1' or marker_id == '4'):
            if marker_id == '1' and current_time - last_command_time > 8:
                time.sleep(2)
                # 向左机械臂爪子放
...
try:
    while True:
        ...
        json_commands_set7 = [
            ...
            {"T": 122, "b": -90, "s": 100, "e": 65, "h": 201, "spd": 100, "acc": 10},
        ]
